export const projects = [
  {
    ...
    chall: [
      ...
      'Swiper and Carousel to display images in the best way',
    ],
    homepage: true,
    type: 'pro',
  },
  {
    ...
    intro: 'Paris Premier Padel Major website built with React.',
    tech: ['react', 'html', 'css', 'javascript'],
    chall: [
      'Confirm React knowledge for front-end and integration',
      'Use Styled-system and Emotion for styling',
      'Advanced use of the Grid layout for news list',
  ...
  },
  {
    ...
    chall: [
      ...
      'Use Styled-system and Emotion for styling',
      'Work with React day picker to select the dates of an hotel',
      'Add Phone number patterns by country with React phone number input',
    ],
    homepage: false,
    type: 'pro',
  },
  {
    ...
    chall: [
      ...
      'CSS grid for the display of the product list',
      'Multi-column layout for advanced text layouts',
    ],
    homepage: false,
    type: 'pro',
  },
  ...
  },
  {
    ...
    tech: ['react', 'redux', 'styled-components', 'node.js', 'mongo-db'],
    chall: [
