export default function Logo() {
  return (
    <svg id="logo-gradient" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 600 600">
      <defs>
