...
This article piece is in line with the following articles: [a Navbar that works without any JS](/blog/css-only-responsive-navbar), [a switch toggle button with no script](/blog/css-only-toggle-switch-button) and [a simple CSS accordion](/blog/css-only-accordion).
...
**TLDR**: See the finalised code for this <a href="https://codepen.io/beumsk/pen/EaYNBJV" target="_blank">CSS only modal on Codepen</a>. You can take any level of inspiration from this and use it in your future developments.
