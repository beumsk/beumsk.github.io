...
5. We can check this <Linkk href="https://nextjs.org/docs/basic-features/eslint">official link for more info on linters</Linkk>
...
4. Check out all <Linkk href="https://prettier.io/docs/en/options.html">settings available</Linkk>
