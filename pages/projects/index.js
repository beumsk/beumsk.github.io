...
export default function Projects(props) {
  const personal = [
    ...
    {title: 'Minesweeper', link: 'projects/minesweeper', img: '/images/minesweeper.jpg'},
    {title: 'whack-a-donkey-kong', link: 'projects/whack-a-donkey-kong', img: '/images/whack-a-donkey-kong.jpg'},
    {title: 'hangman', link: 'projects/hangman', img: '/images/hangman.jpg'},
    {title: 'dad-jokes', link: 'projects/dad-jokes', img: '/images/dad-jokes.jpg'},
    {title: 'giphy-search', link: 'projects/giphy-search', img: '/images/giphy-search.jpg'},
    {title: 'tetris', link: 'projects/tetris', img: '/images/tetris.jpg'},
    {title: 'simon-game', link: 'projects/simon-game', img: '/images/simon-game.jpg'},
    {title: 'drum-machine', link: 'projects/drum-machine', img: '/images/drum-machine.jpg'},
    {title: 'clock', link: 'projects/clock', img: '/images/clock.jpg'},
    {title: 'etch-a-sketch', link: 'projects/etch-a-sketch', img: '/images/etch-a-sketch.jpg'},
    {title: 'calculator', link: 'projects/calculator', img: '/images/calculator.jpg'},
    {title: 'higher-or-lower', link: 'projects/higher-or-lower', img: '/images/higher-or-lower.jpg'},
    {title: 'tic-tac-toe', link: 'projects/tic-tac-toe', img: '/images/tic-tac-toe.jpg'},
    {title: 'sliding-puzzle', link: 'projects/sliding-puzzle', img: '/images/sliding-puzzle.jpg'},
    {title: 'pokemon', link: 'projects/pokemon', img: '/images/pokemon.jpg'},
    {title: 'color-game', link: 'projects/color-game', img: '/images/color-game.jpg'},
    {title: 'brick-breaker', link: 'projects/brick-breaker', img: '/images/brick-breaker.jpg'},
    {title: 'connect-4', link: 'projects/connect-4', img: '/images/connect-4.jpg'},
    {title: 'date-counter', link: 'projects/date-counter', img: '/images/date-counter.jpg'},
    {title: 'quotes', link: 'projects/quotes', img: '/images/quotes.jpg'},
    {title: 'timer', link: 'projects/timer', img: '/images/timer.jpg'}
  ];
  const professional = [{title: 'KPMG Careers'}];
  ...
  return (
    <DefaultLayout title={props.title} description={props.description}>
      <div className="container">
        ...
        <ul>
          <li><Link href="/projects/kpmg-careers">KPMG Careers Belgium</Link></li>
